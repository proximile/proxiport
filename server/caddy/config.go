...
var (
	...
	ErrCaddyUnknownLogLevel                     = errors.New("proxiport log level not a known caddy log level")
...
type Config struct {
	...
	LogLevel         string `mapstructure:"-"` // taken from the proxiport server log level
	DataDir          string `mapstructure:"-"` // taken from the proxiport server datadir
