	...
	testCases := []struct {
		...
		},
		{
			...
			"data": {
				...
				"lport_random": false,
				"scheme": "http",
				"tunnel_url": "https://12345678.tunnels.proxiport.test:443",
				"acl": "127.0.0.1",
				"idle_timeout_minutes": 5,
				"auto_close": 0,
				"http_proxy": true,
		...
		},
		{
			...
			"data": {
				...
				"lport_random": false,
				"scheme": "http",
				"tunnel_url": "https://12345678.tunnels.proxiport.test:8443",
				"acl": "127.0.0.1",
				"idle_timeout_minutes": 5,
				"auto_close": 0,
				"http_proxy": true,
				...
				Server: &Server{
					...
					config: &chconfig.Config{
						...
						Caddy: caddy.Config{
							...
							BaseDomain:       "tunnels.proxiport.test",
