...
/*
ProxiPort RDP proxy uses Apache Guacamole to connect to remote RDP server.
...
These parameters are sent to the ProxiPort proxy via a POST-request and stored there in GuacTokenStore for further handling during the guacd handshaking.
