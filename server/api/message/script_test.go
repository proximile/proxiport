...
func TestDataToEnv(t *testing.T) {
	...
	expected := []string{
		"PROXIPORT_2FA_TOKEN=abcd12",
		"PROXIPORT_2FA_SENDTO=whatever@example.com",
		"PROXIPORT_2FA_TOKEN_TTL=300",
		"PROXIPORT_2FA_USER_AGENT=Go",
		"PROXIPORT_2FA_REMOTE_ADDRESS=::1",
	}
