...
func (as *APIService) GetEffectiveUserExtendedPermissions(user *User) ([]PermissionParams, []PermissionParams) {
	var tunnelsRestricted []PermissionParams
	var commandsRestricted []PermissionParams
