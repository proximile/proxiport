		...
		},
		{
			...
			Config: Config{
				Server: ServerConfig{
					...
					InternalTunnelProxyConfig: clienttunnel.InternalTunnelProxyConfig{
						EnableAcme: true,
						Host:       "tunnel.proxiport.example.com",
					},
				},
			},
		},
...
func TestDatabaseParseAndValidate(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			...
			Database: DatabaseConfig{
				Type: "sqlite",
				Name: "/var/lib/proxiport/proxiport.db",
			},
			ExpectedDriver: "sqlite3",
			ExpectedDSN:    "/var/lib/proxiport/proxiport.db",
		}, {
			Name: "mysql defaults",
			Database: DatabaseConfig{
				Type: "mysql",
		...
		},
		{
			...
			Config: Config{
				API: APIConfig{
					Address:  "0.0.0.0:3000",
					Auth:     "abc:def",
					CertFile: "/var/lib/proxiport/server.crt",
					KeyFile:  "",
				},
			},
		...
		},
		{
			...
			Config: Config{
				API: APIConfig{
					...
					Auth:     "abc:def",
					CertFile: "",
					KeyFile:  "/var/lib/proxiport/server.key",
				},
			},
		...
		},
		{
			...
			Config: Config{
				API: APIConfig{
					...
					KeyFile:    "/var/lib/proxiport/server.key",
					EnableAcme: true,
					BaseURL:    "https://proxiport.example.com",
				},
			},
