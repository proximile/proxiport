...
import (
	...
	"github.com/proximile/proxiport/db/migration/client_groups"
	clientsmigration "github.com/proximile/proxiport/db/migration/clients"
	...
	"github.com/proximile/proxiport/server/scheduler"
	chshare "github.com/proximile/proxiport/share"
	"github.com/proximile/proxiport/share/capabilities"
...
// Server represents a proxiport service
type Server struct {
	*logger.Logger
...
// NewServer creates and returns a new proxiport server
...
// Run is responsible for starting the proxiport service
